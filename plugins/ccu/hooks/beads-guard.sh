#!/usr/bin/env bash
# beads-guard.sh — Claude Code/Codex SessionStart drift warner for tracked beads.
#
# Why this exists:
...
#
#   This hook runs at SessionStart in either host, BEFORE any beads command,
#   and warns when
...
#   - Silent on the happy path: both hosts inject SessionStart stdout into
#     context, so it emits NOTHING unless real drift is detected.
