---
description: Brainstorm 100 ideas and present only the 10 most brilliant, pragmatic ones
argument-hint: [topic]
---
...
2. **Brainstorm 50 ideas** — Think expansively across these dimensions. Use ultrathink to generate at minimum 50 candidate ideas:
   ...
   - **Reliability** — Features that make the system more robust and trustworthy
   - **Cleverness** — Innovative approaches that solve problems in unexpectedly elegant ways
...
3. **Filter ruthlessly** — From the 50+ ideas, eliminate any that:
   ...
   - Sound cool but wouldn't actually matter much in practice

4. **Select the top 10** — Pick the 10 ideas that best combine:
   - **Brilliance** — genuinely clever and innovative, not obvious
   - **Impact** — would make users say "I can't believe this didn't exist before"
   - **Pragmatism** — achievable without heroic engineering effort
   - **Compellingness** — would make someone choose this project over alternatives

5. **Present each idea** — For each of the 10, explain:
   - **What it is** — clear, concise description
   - **Why it's brilliant** — what makes this non-obvious or especially powerful
   - **How it works** — high-level implementation sketch (2-3 sentences)
...
- If two ideas are similar, merge them into the stronger version.
