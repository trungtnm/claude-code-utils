...
description: "Generate tailored quality rules and coding standards for a specific project. Use when the user wants to create project rules, define coding standards, set up quality guidelines, add rules to CLAUDE.md, establish testing standards, or define operational rules for their codebase. Triggers on: 'create project rules', 'set up quality rules', 'define coding standards', 'add quality guidelines', 'establish project conventions', 'create CLAUDE.md rules'. Should also trigger when users say things like 'I want rules before I start coding' or 'set up guardrails for this project'."
---
...
1. `CLAUDE.md` — existing AI instructions, conventions already established
...
> - A) Add to CLAUDE.md (recommended if it exists)
> - B) Create a separate `docs/QUALITY.md`
> - C) Both — compact rules in CLAUDE.md, full reference in docs/QUALITY.md
>
...
If the project already has rules (in CLAUDE.md, linter configs, etc.), respect them:
...
- If CLAUDE.md already has 200+ lines of rules, be selective about what you add. More rules ≠ better rules. Every rule you add should earn its place.
...
- Include a brief reference in CLAUDE.md pointing to the file: `## Quality rules\nSee docs/QUALITY.md for the full project quality ruleset.`

**If writing to both:**
- CLAUDE.md gets the compact, actionable version (what an AI agent needs every session)
